...
const Icon = ({ platform }: { platform: string }) => {
  ...
  switch (platform.toLowerCase()) {
    ...
    case 'apple_podcasts':
      return (<svg viewBox="0 0 24 24" width="24" height="24" aria-label="Apple Podcasts" className={iconClass}><path fill="currentColor" d="M12 0C5.372 0 0 5.372 0 12c0 6.627 5.372 12 12 12 6.627 0 12-5.373 12-12 0-6.628-5.373-12-12-12zm0 2.5c5.247 0 9.5 4.253 9.5 9.5 0 5.247-4.253 9.5-9.5 9.5A9.499 9.499 0 0 1 2.5 12c0-5.247 4.253-9.5 9.5-9.5zm0 1.5a8 8 0 1 0 0 16 8 8 0 0 0 0-16zm0 2.5A5.506 5.506 0 0 1 17.5 12a5.506 5.506 0 0 1-5.5 5.5A5.506 5.506 0 0 1 6.5 12 5.506 5.506 0 0 1 12 6.5zm0 1.5c-2.206 0-4 1.794-4 4s1.794 4 4 4 4-1.794 4-4-1.794-4-4-4zm0 2c1.103 0 2 .897 2 2s-.897 2-2 2-2-.897-2-2 .897-2 2-2zm0 6a1.5 1.5 0 0 1 1.5 1.5v2a1.5 1.5 0 0 1-3 0v-2A1.5 1.5 0 0 1 12 16.5z"/></svg>);
    default:
      return null;
  }
};
